...
<Image  src={aboutimg} alt='img' />
  ...
  <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-end p-4 '>
    <p className='font-mono  leading-8  text-slate-700'>
      Welcome to <span className='font-semibold text-indigo-300'>[Tourist]</span>, where your journey begins! We are more than just a travel app; we're curators of unforgettable adventures. Our passion lies in crafting travel experiences that transcend the ordinary, leaving you with memories to cherish. Our mission is simple yet powerful – to inspire and empower travelers like you to explore the world with confidence, curiosity, and an unwavering sense of adventure. Let [Tourist] be your compass as you navigate the wonders of our planet, one journey at a time.
    </p>
  </div>
</div>
